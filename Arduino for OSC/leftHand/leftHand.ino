...
void setup() {
    ...
    OscWiFi.publish(host, publish_port, "/lefthand/pinky", pinkyFinger)
        ->setFrameRate(30.f);

    OscWiFi.publish(host, publish_port, "/lefthand/ring", ringFinger)
        ->setFrameRate(30.f);

    OscWiFi.publish(host, publish_port, "/lefthand/middle", middleFinger)
        ->setFrameRate(30.f);

    OscWiFi.publish(host, publish_port, "/lefthand/index", indexFinger)
        ->setFrameRate(30.f);

    OscWiFi.publish(host, publish_port, "/lefthand/thumb", thumbFinger)
        ->setFrameRate(30.f);
