Shader "Custom/Geo"
{
	Properties
	{
		...
		_BladeHeightRandom("Blade Height Random", Range(0,0.5)) = 0.3
	...
	void geo(triangle vertexOutput IN[3] : SV_POSITION, inout TriangleStream<geometryOutput> triStream)
	{
		...
		float3x3 windRotation = AngleAxis3x3(UNITY_PI * windSample, wind);//windSample是float2，为什么可以写在这里
	...
	SubShader
	{
		...
		Pass
		{
			...
			{	
				...
				float4 col2 = lerp(_BottomColor * shadow, _TopColor * shadow, i.uv.y);
